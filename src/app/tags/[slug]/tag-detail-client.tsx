...
import { Terminal, ArrowLeft, Calendar, Clock, Eye, Heart, Hash, FileText } from "lucide-react"
...
export function TagDetailClient({ tag, articles }: TagDetailClientProps) {
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
              ...
              <div className="text-sm font-mono text-gray-400">tags/{tag.slug}.tag</div>
            ...
            <div className="p-6 font-mono">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-green-400">grep -r "#{tag.name}" articles/</span>
              </div>
              
              <div className="ml-6 space-y-2 text-sm">
                <div className="text-blue-400">
                  Found {articles.length} articles tagged with #{tag.name}
                </div>
                <div className="text-gray-300">
                  <span className="text-green-400">-rw-r--r--</span> 
                  <span className="ml-2 text-orange-400">{tag.slug}.tag</span>
                  <span className="ml-4 text-gray-500">{tag.description}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold font-mono text-white">#{tag.name}</h1>
          ...
          {tag.description && (
            <div className="bg-gray-800 rounded p-4 border border-gray-600">
              <div className="text-xs font-mono text-gray-400 mb-2">
                <span className="text-green-400">$</span> cat tag_description.txt
              </div>
              <p className="text-gray-300 font-mono">{tag.description}</p>
            </div>
          )}
        </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs font-mono text-gray-500">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="px-2 py-1 bg-gray-800 border border-gray-600 rounded text-xs">
                        {article.category}
                      </span>
                    </div>
                  </div>
            ...
            >
              <div className="bg-gray-900 rounded-lg border border-gray-700 p-8">
                ...
                <p className="text-gray-500 font-mono">
                  # No articles tagged with #{tag.name} yet. Check back later!
                </p>
              </div>
            </motion.div>
          )}
